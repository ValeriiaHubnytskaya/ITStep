...
switch( strtoupper($_SERVER['REQUEST_METHOD'])){
    ...
    case 'POST' :  
        ...
        if(empty($_POST['login'])){
            $_SESSION['reg_error'] = "Введіть логін";
        }
        else if(empty($_POST['name'])){
            $_SESSION['reg_error'] = "Введіть ім'я";
        }
        else if(empty($_POST['password'])){
            $_SESSION['reg_error'] = "Введіть пароль";
        }
        else if(empty($_POST['email'])){
            $_SESSION['reg_error'] = "Введіть e-mail";
        }
        else if($_POST['password'] !== $_POST['confirm']){
            $_SESSION['reg_error'] = "Паролі не співпадають";
        }
        else {         
